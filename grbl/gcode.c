            ...
            case 4: case 53:
                ...
                case 80:
                    ...
                    case 17: case 18: case 19:
                        ...
                        default: FAIL(STATUS_GCODE_AXIS_COMMAND_CONFLICT); break;
                        }
                        break;
                        case 90: case 91:
                            if (mantissa == 0) {
...
////            } else {
//                printPgmString(PSTR("\r\nstf ")); printFloat(gc_state.feed_rate, 2);
//                gc_block.values.f = gc_state.feed_rate; // Push last state feed rate
//                printPgmString(PSTR("\r\nf ")); printFloat(gc_block.values.f, 2);
//            }
...
//                printPgmString(PSTR("\r\nx ")); printFloat(x, 2);   //-6.85
//                printPgmString(PSTR("\r\ny ")); printFloat(y, 2);   //1.28
...
//                    printPgmString(PSTR("\r\ntgt_r ")); printFloat(target_r, 2);    //5.61
//                    printPgmString(PSTR("\r\nijkX ")); printFloat(gc_block.values.ijk[axis_0], 2);  //-1.39
//                    printPgmString(PSTR("\r\nijkY ")); printFloat(gc_block.values.ijk[axis_1], 2);  //00

                    // Compute arc radius for mc_arc. Defined from current location to center.
                    gc_block.values.r = hypot_f(gc_block.values.ijk[axis_0], gc_block.values.ijk[axis_1]);

//                    printPgmString(PSTR("\r\nval_r ")); printFloat(gc_block.values.r, 2);   //1.39
//                    printPgmString(PSTR("\r\n"));
