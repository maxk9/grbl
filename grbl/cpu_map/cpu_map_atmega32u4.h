...
#define GRBL_PLATFORM "Atmega23u4"

#if BOARD != BOARD_PROMICRO
    #error Only PROMICRO supported
#endif

// Define step pulse output pins. NOTE: All step bit pins must be on the same port.
#define STEPPING_DDR_MOTA DDRC
#define STEPPING_MOTA     PORTC    //promicro
#define STEPPING_DDR_MOTB DDRD     //promicro
#define STEPPING_MOTB     PORTD    //promicro
#define STEPPING_DDRZ     DDRE     //promicro
#define STEPPING_PORTZ     PORTE    //promicro
#define A_STEP_BIT         6    //portc6 promicro
#define B_STEP_BIT         7    //PORTD7 promicro
#define Z_STEP_BIT         6    //porte6
//#define STEP_MASK       ((1<<X_STEP_BIT)|(1<<Y_STEP_BIT)|(1<<Z_STEP_BIT)) // All step bits

// Define step direction output pins. NOTE: All direction pins must be on the same port.
#define DIRECTION_DDR     DDRD
#define DIRECTION_PORT    PORTD
#define X_DIRECTION_BIT   1  //port d1 promicro
#define Y_DIRECTION_BIT   0  //port d0
#define Z_DIRECTION_BIT   4  //port d4
#define DIRECTION_MASK    ((1<<X_DIRECTION_BIT)|(1<<Y_DIRECTION_BIT)|(1<<Z_DIRECTION_BIT)) // All direction bits

// Define stepper driver enable/disable output pin.
#define STEPPERS_DISABLE_DDR    DDRB
#define STEPPERS_DISABLE_PORT   PORTB
#define STEPPERS_DISABLE_BIT    4  // promicro portb4
...
#define X_LIMIT_BIT      6  // promicro portB6
...
#endif
#define LIMIT_MASK       (1<<X_LIMIT_BIT) // All limit bits
